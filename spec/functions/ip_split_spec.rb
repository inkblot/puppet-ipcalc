...
describe 'ip_split' do
    it { should run.with_params('10.0.0.1/23').and_return(["10.0.0.0/24", "10.0.1.0/24"]) }
    it { should run.with_params('10.0.0.1/255.255.254.0').and_return(["10.0.0.0/24", "10.0.1.0/24"]) }
    it { should run.with_params('10.0.0.1/255.255.255.255').and_raise_error(ArgumentError) }
