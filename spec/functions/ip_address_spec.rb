...
describe 'ip_address' do
  it { is_expected.to run.with_params('10.0.0.1/24').and_return('10.0.0.1') }
  it { is_expected.to run.with_params('10.0.0.1/255.255.255.0').and_return('10.0.0.1') }
  ...
  it { is_expected.to run.with_params('fd00::1/24').and_return('fd00::1') }
  it { is_expected.to run.with_params('fd00::1/129').and_raise_error(IPAddr::InvalidPrefixError) }
  it { is_expected.to run.with_params('fd00:g0:1/24').and_raise_error(IPAddr::InvalidAddressError) }
end
