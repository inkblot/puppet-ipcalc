...
describe 'ip_broadcast' do
    ...
    it { should run.with_params('fd00::1/120').and_return('fd00::ff/120') }
    it { should run.with_params('fd00::1/120',2).and_return('fd00::fd/120') }
    it { should run.with_params('fd00::1/120',255).and_return('fd00::/120') }
