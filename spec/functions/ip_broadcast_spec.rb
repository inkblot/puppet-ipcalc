...
describe 'ip_broadcast' do
  it { is_expected.to run.with_params('10.0.0.1/24').and_return('10.0.0.255/24') }
  it { is_expected.to run.with_params('10.0.0.1/24', 2).and_return('10.0.0.253/24') }
  it { is_expected.to run.with_params('10.0.0.1/24', 255).and_return('10.0.0.0/24') }
  ...
  it { is_expected.to run.with_params('fd00::1/120').and_return('fd00::ff/120') }
  it { is_expected.to run.with_params('fd00::1/120', 2).and_return('fd00::fd/120') }
  it { is_expected.to run.with_params('fd00::1/120', 255).and_return('fd00::/120') }
