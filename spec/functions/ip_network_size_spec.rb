...
describe 'ip_network_size' do
    it { should run.with_params('10.0.0.1/24').and_return(256) }
    it { should run.with_params('10.0.0.1/255.255.255.0').and_return(256) }
    ...
    it { should run.with_params('fd00::1/120').and_return(256) }
