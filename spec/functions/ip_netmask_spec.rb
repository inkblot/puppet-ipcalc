...
describe 'ip_netmask' do
  it { is_expected.to run.with_params('10.0.0.1/24').and_return('255.255.255.0') }
  it { is_expected.to run.with_params('10.0.0.1/255.255.255.0').and_return('255.255.255.0') }
  ...
  it { is_expected.to run.with_params('fd00::1/120').and_return('ffff:ffff:ffff:ffff:ffff:ffff:ffff:ff00') }
